...
export const SISU_METER_THICKNESS = 10;
...
export const TOP_HUD_EXP_BAR_HEIGHT = 30;
...
export const TOP_HUD_LEVEL_Y = 34;
export const TOP_HUD_LEVEL_GAP_FROM_EXP_BAR_RIGHT = TOP_HUD_LEVEL_X - (TOP_HUD_EXP_BAR_X + TOP_HUD_EXP_BAR_WIDTH);
...
// Quest panel FAME bar
export const QUEST_FAME_BAR_WIDTH = TOP_HUD_EXP_BAR_WIDTH;
export const QUEST_FAME_BAR_HEIGHT = TOP_HUD_EXP_BAR_HEIGHT;
export const QUEST_FAME_BAR_RIGHT_PADDING = 20;
export const QUEST_FAME_BAR_TRUST_GAP = TOP_HUD_LEVEL_GAP_FROM_EXP_BAR_RIGHT;
export const QUEST_FAME_BAR_ROW_HEIGHT = 32;
