...
import { drawLockedElement, lerpColor } from '../utils.js';
import {
...
export function renderProgressBar(ctx, canvas, state) {
  ...
  const fillValue = clampNumber(Number(state?.progressBar?.fill) || 0, 0, 100);
