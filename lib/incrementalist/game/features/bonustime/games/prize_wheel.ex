defmodule Incrementalist.Game.Features.BonusTime.Games.PrizeWheel do
  @moduledoc """
  Prize Wheel mini-game rules.
  """
  alias Incrementalist.Game.Constants

  def roll_reward(streak) do
    rules = Constants.bonustime_game_rules()["prize_wheel"]
    chances = rules["chances"]

    # Calculate number of rolls based on streak
    # streak_scaling: { "interval": 30, "max_bonus": 2 }
    ...
    # Return 1-indexed tier (tier_1 to tier_7) and 1-indexed list of rolls
    {best_tier_index + 1, Enum.map(rolls, &(&1 + 1))}
  end
